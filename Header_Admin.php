    ...
    <div class="header">
        <div class="container">
            <div class="logo">
                ...
                <h1>
                    <a href="AdminHome.php">
                        Co e Loc
                        Admin <script src="https://unpkg.com/@lottiefiles/lottie-player@0.4.0/dist/lottie-player.js"></script>
            ...
            <div class="top-nav">
                ...
                <ul>
                    <li><a class="hvr-sweep-to-bottom">Squad</a>
                        <ul>
                            <li><a href="Admin_AddSquad.php">Add Squad</a></li>
                            <li><a href="Admin_ViewSquad.php">View Squad</a></li>
                        </ul>
                    </li>
