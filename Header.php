    ...
    <div class="header">
        <div class="container">
            <div class="logo">
                ...
                <h1>
                    <a href="index.html">
                        Co De Loc <script src="https://unpkg.com/@lottiefiles/lottie-player@0.4.0/dist/lottie-player.js"></script>
            ...
            <div class="top-nav">
                <span class="menu"><img src="images/menu.png" alt="" height="100px"> </span>
                <ul>
                    <li><a href="login.php" class="hvr-sweep-to-bottom">Login</a></li>
                    <li><a href="PublicRegister.php" class="hvr-sweep-to-bottom">Register</a></li>
                    <!-- <li><a href="blog.html" class="hvr-sweep-to-bottom">Blog</a></li>
                    <li><a href="typo.html" class="hvr-sweep-to-bottom">Typo </a></li>
